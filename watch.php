<?php
/*
 * This file will watch for changes to the Woo Starter and
...
$it->append( new RecursiveIteratorIterator( new RecursiveDirectoryIterator( __DIR__ . '/src', FilesystemIterator::SKIP_DOTS ) ) );
